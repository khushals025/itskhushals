      ...
      <div className='education__timeline'>
        ...
        <div className='education__container'>
          ...
          <div className='education-text-box'>
            <h3>Master of Science in Engineering Science - Robotics</h3>
        ...
        <div className='education__container'>
          ...
          <div className='education-text-box'>
            ...
            <p><RiGraduationCapFill/> Course Work : Computer Programming, Calculus, Linear Algebra, Advanced Engineering Mathematics, Diffrential Equations </p>
          </div>
        </div>
